    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <div className="buttons_src-components-HomepageDownload-styles-module">
          <a
            href={require('/docs/FBM_Mac_21.0.1.zip').default}
            className="button button--secondary button--lg"
            download="FBM_Mac_21.0.1.zip"
          >
            macOS
          </a>
          &nbsp;&nbsp;&nbsp;&nbsp;
          <a
            href={require('/docs/FBM_Windows_21.0.1.zip').default}
            className="button button--secondary button--lg"
            download="FBM_Windows_21.0.1.zip"
          >
            Windows
          </a>
        </div>
